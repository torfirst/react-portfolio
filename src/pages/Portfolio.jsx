...
export default function Portfolio() {
    ...
    return (
        <div className="reset">
            ...
            <h2>portfolio</h2>
            <p className="portfolioBlurb">Click on a <span className="repo">title</span> to go to the project repository, or click on an image tile to go to the deployed project.</p>
